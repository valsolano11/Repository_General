    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const fichaInstructor = response.data.map((relacion) => ({
              ...relacion,
              nombreUsuario: relacion.Usuario ? relacion.Usuario.nombre : "Desconocido",
              NumeroFicha: relacion.Ficha ? relacion.Ficha.NumeroFicha : "Desconocido",
              Programa: relacion.Ficha ? relacion.Ficha.Programa : "Desconocido",
              Jornada: relacion.Ficha ? relacion.Ficha.Jornada : "Desconocido",
              InstructorNombre: relacion.Instructore ? relacion.Instructore.nombre : "Desconocido",
          }));
        ...
        return (
            ...
            >
                ...
                <div className="max-w-7xl overflow-auto">
                    ...
                    <MUIDataTable
                        title={<span className="custom-title">FICHA POR INSTRUCTOR</span>} 
                        data={data}
                        columns={columns}
                        options={{
                        responsive: "standard",
